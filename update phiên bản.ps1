# UTF-8 BOM ở đầu file để PowerShell 5.1 hiểu encoding chuẩn UTF-8.
# Nếu mở file bằng Notepad++ phải thấy "UTF-8-BOM" ở thanh status dưới.

Write-Host "==== V75 deploy v0.6.0 ====" -ForegroundColor Cyan

# Dùng $PSScriptRoot để lấy folder chính file script đang nằm — tránh
# hardcode path tiếng Việt vốn rất dễ hỏng khi encoding sai.
$proj = $PSScriptRoot
